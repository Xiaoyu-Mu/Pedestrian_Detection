...
def detect(cfg,
    ...
    for i, (path, img, im0, vid_cap) in enumerate(dataloader):
        ...
        if det is not None and len(det) > 0:
            ...
            # Print results to screen image 1/3 data\000493.jpg: 288x416 5 persons, Done. (0.869s)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--images', type=str, default='data', help='需要进行检测的图片文件夹')
